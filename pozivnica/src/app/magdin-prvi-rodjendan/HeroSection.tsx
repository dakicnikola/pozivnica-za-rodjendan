...
const HeroSection = () => {
  return (
    <div className="relative w-full h-full mb-0 bg-gradient-to-b from-[#fbeee9] via-[#fbeee9] to-[#eaf0f3]">
      ...
      <div className="z-20 absolute items-center justify-center text-center text-white drop-shadow-lg top-60 right-10">
